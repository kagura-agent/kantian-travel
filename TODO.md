...
- [ ] Track: Wattage (faizannraza/wattage) - 20⭐ (07-29). Token-spend profiler + cost-regression gate. 8 detectors, convergence engine (trailing-streak non-convergence classification). OTel-based. CI integration. Deep read done. Revisit 08-05
...
- [ ] Track: Observal (Observal/Observal) - 2,246⭐ (07-29 followup, +1.3%). v1.10.7 released. CI hardening, namespace refactor. THRIVING 6/6. Revisit 08-05
- [ ] Track: Superserve (superserve-ai/superserve) - 434⭐ (07-29 followup, +3.6%). MCP 0.1.3, billing UI, SDK truncated flag, preview URL auth. Steady. Revisit 08-05
- [ ] Track: open-kritt (Kritt-ai/open-kritt) - 438⭐ (07-29 followup, +69%). v1.2.0 released. Model-per-depth selection. 29 external PRs/30d. Strong growth. Revisit 08-05
- [x] Track: mentor (smixs/mentor) - 65⭐ (07-27 followup, +86%). 8d stale (last push 07-19), 0 forks/issues/PRs. SOLO 0/6. Star growth organic but no community forming. All patterns already extracted. **Downgraded to monthly.** Revisit 08-27
...
- [x] Track: context-labs/halo - 1,116⭐ (07-24 followup, +1.4%). THRIVING 6/6. Engine v0.2.1, PR#77 multi-file dataset union, PR#76 ModelBehaviorError retry, Issue#70 detection_basis taxonomy evolved. Revisit 07-31
...
- [ ] Track: GenseeAI/gensee-crate - 112⭐ (07-27 followup, +65%). REVIVED: v0.2.0 (07-22) — transactional runtime (tclone process forks), parallel fork groups with winner selection, Codex-mediated completion, Tauri dashboard, VS Code/Cursor hooks. GROWING 4/6, 10 forks, 4 issue authors. Revisit 08-03
